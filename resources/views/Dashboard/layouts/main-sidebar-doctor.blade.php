			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('doctor.invoices.index') }}">قائمة الكشوفات</a></li>
							<li><a class="slide-item" href="{{route('doctor.completedInvoices')}}">قائمة الكشوفات المكتملة</a></li>
							<li><a class="slide-item" href="{{route('doctor.reviewInvoices')}}">قائمة المراجعات</a></li>
						</ul>
					</li>
