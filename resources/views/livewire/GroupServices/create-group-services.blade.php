<div>
    ...
    @if($show_table)
            @include('livewire.GroupServices.group_table')
    @else
       ...
       {{--
        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties )
            <div class="form-group">
                <label>{{trans('group_service.' . $localeCode . '.name')}}</label>
                <input type="text"    wire:model="translations.{{$localeCode}}.name" name="{{$localeCode }}[name]" class="form-control" >
            </div>
        @endforeach

        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties )
            <div class="form-group">
                <label>{{trans('group_service.' . $localeCode . '.notes')}}</label>
                <textarea  wire:model="translations.{{$localeCode}}.notes" name="{{$localeCode }}[notes]" class="form-control" ></textarea>
            </div>
        @endforeach
--}}
        <div class="form-group">
